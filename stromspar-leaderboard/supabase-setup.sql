...
create table if not exists public.leaderboard_entries (
  ...
  annual_consumption_kwh integer not null default 3500 check (annual_consumption_kwh > 0),
...
alter table public.leaderboard_entries add column if not exists annual_consumption_kwh integer not null default 3500;
